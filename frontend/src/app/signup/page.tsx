    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`${baseUrl}/api/auth/register`, {
                ...
                body: JSON.stringify({ email, password, full_name: name, tier: 'free' }),
            });
        ...
        <div className="arena-container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '2rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <h1 className="text-glow-gold" style={{ fontSize: '2rem', fontWeight: 800 }}>Join Samvad AI</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>Start your journey in the Digital Colosseum</p>
                </div>
